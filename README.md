...
![Версия прошивки TX](https://img.shields.io/badge/Версия_прошивки-TX_3.4-blue)
...
7. [Полное руководство по настольному приложению](#полное-руководство-по-настольному-приложению)
   ...
   - [Мастер настройки подключения](#мастер-настройки-подключения)
...
- **Веб-интерфейс:** Настройка контроллера и прошивка через браузер
- **Настольное приложение:** Удобное приложение для Windows, Linux и macOS
...
│  │  • Настройка WiFi                                       │    │
│  │  • Добавление/удаление приёмников                       │    │
│  │  • OTA обновление                                       │    │
│  │  • Мониторинг                                           │    │
│  └─────────────────────────────────────────────────────────┘    │
│                              │                                  │
...
- Веб-сервер с полным веб-интерфейсом
- OTA (Over-The-Air) обновление прошивки
- Поддержка до 10 приёмников
- Авторизация пользователей
- NTP-синхронизация времени
- API эндпоинты для интеграции с настольным приложением
...
- Управление приёмниками (включение/выключение реле)
- Управление конфигурацией приёмников через веб-интерфейс
...
1. Перейдите на страницу "Управление приемниками"
2. Нажмите "Добавить приемник"
3. Заполните поля:
   - **Имя:** понятное название (например, "Гараж", "Освещение")
   - **Адрес:** HEX адрес приёмника (например, 01, 0A, 1F)
4. Включите приёмник (checkbox)
5. Нажмите "Сохранить настройки"
...
![screen](/screen/capture_260121_121148.png)
...
2. **Таблица со списком всех настроенных приёмников:**
...
![screen](/screen/capture_260121_140251.png)
...
2. **Управление приемниками:**
   - Нажмите для открытия веб страницы где можно редактировать, добавлять, удалять приемники
...
|-------|----------|----------|
| GET | `/status` | Получение информации об устройстве |
...
| GET | `/receiver_management` | Страница управления приёмниками |
| GET | `/ota_update` | Страница OTA обновления |
| POST | `/relay_on` | Включение реле |
| POST | `/relay_off` | Выключение реле |
...
- [ ] Перенести настройки приемников полностью в приложение
...
**Дата обновления:** 21 января 2026 г.
